...
def force_memory_deallocation():
    ...
    large_objects = []
    # Suppress the deprecated `torch.distributed.reduce_op` FutureWarning that
    # gets triggered when iterating over gc.get_objects() touches stale torch
    # aliases. Doesn't affect behavior.
    import warnings
