        ...
        for n in range(p.n_iter):
            ...
            if not p.disable_extra_networks:
                ...
                if getattr(sd_model, '_cached_lora_sig', None) == current_extra_data_sig:
                    ...
                    sd_model.forge_objects_after_applying_lora.unet = sd_model._cached_lora_unet
                    sd_model.forge_objects_after_applying_lora.clip = sd_model._cached_lora_clip
                else:
            ...
            for i, x_sample in enumerate(x_samples_ddim):
                ...
                if not opts.do_not_show_images:
