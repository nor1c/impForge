...
def reload_model_for_text_encoder_change():
    ...
    print("Text encoder setting changed - forcing model reload to apply new text encoder")
    # Force model reload by clearing any cached state and reloading
...
def configure_opts_onchange():
    ...
    # Model will be loaded on Generate click, not on dropdown change
    ...
    shared.opts.onchange("sd_text_encoder", wrap_queued_call(lambda: main_thread.run_and_wait_result(reload_model_for_text_encoder_change)), call=False)
